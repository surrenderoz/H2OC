...
// A company situated in Cape Town and incorporated within the laws of South Africa with registration number: 2013/033896/07 || Email: treasury@exchangetrust.co.za,
...
contract H2OC is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee,uint256 _lpFee,uint256 _DexFee,address routerAddress,address feeaddress,address tokenOwner,address service) public payable {
        ...
        _maxTxAmount = (_tTotal * 50 / 1000) * 10 ** _decimals;
